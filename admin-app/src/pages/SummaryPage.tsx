  ...
  return (
    <section className="sg25-card h-full min-w-0 overflow-hidden p-4 sm:p-5">
      <div className="flex items-center justify-between gap-3">
        ...
        <a href="/admin/orders" className="sg25-btn sg25-btn-ghost shrink-0">
          View all
          <Icon name="arrow-up-right" className="h-4 w-4" />
        </a>
      </div>
  ...
  return (
    <section className="sg25-card flex h-full flex-col p-4 sm:p-5">
      ...
      <div className="mt-auto pt-4">
        <a href="/admin/inventory" className="sg25-btn sg25-btn-primary w-full">
          Review inventory
        </a>
      </div>
    </section>
  ...
  return (
    <section className="sg25-card p-4 sm:p-5">
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <a href="/admin/nexus" className="sg25-btn sg25-btn-ghost ml-auto shrink-0 self-start">
          View nexus
          <Icon name="arrow-up-right" className="h-4 w-4" />
        </a>
      </div>
...
export function SummaryPage() {
  ...
  const summaryQuery = useQuery({
    queryKey: ["admin-summary", preset, channel],
  ...
  const salesSummaryQuery = useQuery({
    queryKey: ["admin-summary", salesPreset, channel],
  ...
  const productSummaryQuery = useQuery({
    queryKey: ["admin-summary", productPreset, channel],
