...
test("admin free shipping waives the customer charge without removing label metadata or carrier expense", () => {
  ...
  const selected = selectManualOrderRateFromToken(
    ...
    { actor: { id: "admin-1", email: "admin@saigoods.com" }, approvedAt: "2026-08-27T15:00:01.000Z" },
  );
