import { resolveCheckoutSalesTax } from "./checkout-tax.js";
...
/**
 * Full cart quote with shipping (ZIP-based or free per CHECKOUT_FREE_SHIPPING) and destination tax
 * (TaxJar and/or CHECKOUT_ZIP_TAX_BPS / CHECKOUT_STATE_TAX_BPS).
 ...
 */
export async function buildFullCheckoutQuote(items, address) {
  ...
  const taxMeta = await resolveCheckoutSalesTax({
    address: addr,
    subtotalCents: quote.subtotalCents,
    shippingCents: quote.shippingCents,
    taxIncludesShipping: includeShip,
  });
