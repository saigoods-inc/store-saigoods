...
export function paymentRuntimeReadiness() {
  ...
  return {
    ...
    embeddedCheckoutReady: environment === "sandbox" && coreConfigured && applicationIdConfigured,
    paymentLinkReady: environment === "sandbox" && coreConfigured && isStorefrontPaymentLinkCompatibleWithShippingMode(),
