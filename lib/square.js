...
export async function createPaymentLink({ quote, customer, orderId }) {
  ...
  /**
   * Line items only; shipping/taxes/contact/address come from Square checkout + your Dashboard rules.
   * Do not send `shipping_fee` here so Square applies your configured rates.
   */
