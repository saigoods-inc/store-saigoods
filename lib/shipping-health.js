...
export function shippingRuntimeReadiness({ warehouseConfigured: warehouseOverride } = {}) {
  ...
  return {
    provider: String(process.env.SHIPPING_RATE_PROVIDER || "shippo").trim().toLowerCase(),
    tokenMode,
    ...
    checkoutAddressValidationReady: tokenMode === "test" && checkoutAddressValidationEnabled,
    warehouseAddressValidationReady: tokenMode === "test",
  };
}
