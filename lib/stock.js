...
export function buildInventoryDashboardOverview() {
  ...
  for (const product of products) {
    ...
    productGroups.push({
      ...
      subtotal: {
        ...
        cartonsSold: subSoldHasBaseline ? subSoldSum : null,
      },
      sizes: sizesOut,
    });
  }
  ...
  return {
    summary: {
      totalCartonsLeft,
      totalBoxesLeft,
      totalCartonsSold: hasAnySoldBaseline ? totalCartonsSoldSum : null,
      activeVariantRows,
