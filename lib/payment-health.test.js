...
test("production and missing environments fail the sandbox safety policy", () => {
  withPaymentEnv({ SQUARE_ENVIRONMENT: "production", SQUARE_WEBHOOK_SIGNATURE_KEY: "configured" }, () => {
    const readiness = paymentRuntimeReadiness();
