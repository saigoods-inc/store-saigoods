...
export function buildOrderQuoteSnapshotColumns({ quote, shippingAddress }) {
  ...
  return {
    ...
    selected_shipping_rate_snapshot_json: normalizeJsonObjectOrNull({
      ...
      freeShippingApplied: shipping.freeShippingApplied === true,
      freeShippingSource: normalizeOptionalText(shipping.freeShippingSource),
      carrierTotalAmountCents: normalizeNonNegativeCents(shipping.carrierTotalAmountCents),
      shippingDiscountCents: normalizeNonNegativeCents(shipping.shippingDiscountCents),
    }),
