...
/**
 * @param {{ orderId: string, paymentId: string, paidTotalCents?: number, customerAddress?: string | null }} args
 ...
 */
export async function markOrderPaid({ orderId, paymentId, paidTotalCents, customerAddress }) {
  const client = getClient();
