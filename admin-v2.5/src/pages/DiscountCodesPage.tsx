...
function KpiCard({ label, value, description, icon }: { label: string; value: string; description: string; icon: "tag" | "receipt" | "bar-chart" | "pin" }) {
  return (
  ...
  return (
    <div className="space-y-4">
      <section>
        ...
        <p className="mt-1 text-[15px] text-sg-muted">View one-time Hardin County discount codes for eligible local customers.</p>
      </section>
      ...
      <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
        ...
        <KpiCard label="Local Area" value="Hardin" description="Tennessee county" icon="pin" />
      </section>
