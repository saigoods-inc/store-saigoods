...
-- --- Admin fulfillment workflow (patch-orders-admin-fulfillment-workflow.sql) ---
...
comment on column public.orders.shippo_from_address_override_json is 'Optional sender override for Shippo.';
comment on column public.orders.shippo_return_address_override_json is 'Optional return address override for Shippo.';
